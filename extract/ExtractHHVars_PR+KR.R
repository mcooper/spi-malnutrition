...
for (i in 1:nrow(usefiles)){
  cat(usefiles$cc[i], usefiles$num[i], usefiles$subversion[i], nrow(all), '\n')
  ...
  #     stop('Mismatches in wealth data for ', usefiles$WI[i])
  #   }
  # 
