...
sp@data$X2020[sp@data$SOVEREIGNT == "Federated States of Micronesia"] <- gdpdat$Value[gdpdat$Country.or.Area == 'Micronesia (Federated States of)' & gdpdat$Year == 2016]
sp@data$X2020[sp@data$SOVEREIGNT == "Western Sahara"] <- gdpdat$Value[gdpdat$Country.or.Area == 'Mauritania' & gdpdat$Year == 2016]
...
sp@data$X2020[sp@data$SOVEREIGNT == "Kashmir"] <- gdpdat$Value[gdpdat$Country.or.Area == 'India' & gdpdat$Year == 2016]

#Need to decide on scale and make a template raster
r <- raster('templateRaster.tif')

rasterize(sp, r, field="X2020", fun='mean')
